...
def check_id(ID, name=..., config=..., pos=...): # -> bool:
    """
...
def fix_id(ID, config=..., pos=...): # -> str | None:
    """
...
_token_regex = ...
def check_token(token, attr_name, config=..., pos=...): # -> bool:
    """
...
def check_mime_content_type(content_type, config=..., pos=...): # -> bool:
    """
...
def check_anyuri(uri, config=..., pos=...): # -> bool:
    """
    Raises a `~astropy.io.votable.exceptions.VOTableSpecError` if
...
def validate_schema(filename, version=...): # -> tuple[int | Any, bytes, bytes]:
    """
