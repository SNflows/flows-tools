...
class BaseLowLevelWCS(metaclass=abc.ABCMeta):
    ...
    def array_index_to_world_values(self, *index_arrays): # -> None:
        """
    ...
    def world_to_array_index_values(self, *world_arrays): # -> NDArray[int_] | tuple[NDArray[int_], ...]:
        """
    ...
    @property
    @abc.abstractmethod
    def world_axis_object_components(self): # -> None:
        """
    ...
    @property
    @abc.abstractmethod
    def world_axis_object_classes(self): # -> None:
        """
...
UCDS_FILE = ...
def validate_physical_types(physical_types): # -> None:
    """
