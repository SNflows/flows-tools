...
def descr(col): # -> tuple[Unknown, Unknown | Literal['O'], Unknown | tuple[()]]:
...
def has_info_class(obj, cls): # -> bool:
...
class TableColumns(OrderedDict):
    ...
    def __getitem__(self, item): # -> _VT@OrderedDict | Self@TableColumns:
    ...
    def __setitem__(self, item, value, validated=...): # -> None:
        """
    ...
    def isinstance(self, cls): # -> list[Unknown]:
        """
    ...
    def not_isinstance(self, cls): # -> list[Unknown]:
        """
...
class PprintIncludeExclude(TableAttribute):
    ...
    attributes.
    """
    def __get__(self, instance, owner_cls): # -> Self@PprintIncludeExclude:
        """Get the attribute.
    ...
    def __set__(self, instance, names): # -> None:
    ...
    def __call__(self): # -> PprintIncludeExclude | None:
...
class Table:
    ...
    **kwargs : dict, optional
    ...
    def as_array(self, keep_byteorder=..., names=...): # -> NDArray[float64] | NDArray[Any]:
        """
    ...
    def __init__(self, data=..., masked=..., names=..., dtype=..., meta=..., copy=..., rows=..., copy_indices=..., units=..., descriptions=..., **kwargs) -> None:
        ...
    
    def __getstate__(self): # -> tuple[OrderedDict[Unknown, BaseColumn | Unknown], MetaData | OrderedDict[Unknown, Unknown] | Unknown]:
        ...
    ...
    def filled(self, fill_value=...): # -> Self@Table:
    ...
    def add_index(self, colnames, engine=..., unique=...): # -> None:
        '''
    ...
    def index_mode(self, mode): # -> _IndexModeContext:
        '''
    ...
    def __array__(self, dtype=...): # -> Any | NDArray[float64] | NDArray[Any]:
    ...
    def itercols(self): # -> Generator[Unknown, None, None]:
        """
    ...
    @property
    def has_mixin_columns(self): # -> bool:
        """
    ...
    @property
    def has_masked_columns(self): # -> bool:
    ...
    @property
    def has_masked_values(self): # -> bool:
    ...
    def pprint(self, max_lines=..., max_width=..., show_name=..., show_unit=..., show_dtype=..., align=...): # -> None:
    ...
    @format_doc(_pprint_docs)
    def pprint_all(self, max_lines=..., max_width=..., show_name=..., show_unit=..., show_dtype=..., align=...): # -> None:
    ...
    def show_in_notebook(self, tableid=..., css=..., display_length=..., table_class=..., show_row_index=...):
    ...
    def show_in_browser(self, max_lines=..., jsviewer=..., browser=..., jskwargs=..., tableid=..., table_class=..., css=..., show_row_index=...): # -> None:
    ...
    def pformat(self, max_lines=..., max_width=..., show_name=..., show_unit=..., show_dtype=..., html=..., tableid=..., align=..., tableclass=...): # -> list[str]:
    ...
    @format_doc(_pformat_docs, id="{id}")
    def pformat_all(self, max_lines=..., max_width=..., show_name=..., show_unit=..., show_dtype=..., html=..., tableid=..., align=..., tableclass=...): # -> list[str]:
        """Return a list of lines for the formatted string representation of
        the entire table.
    ...
    def more(self, max_lines=..., max_width=..., show_name=..., show_unit=..., show_dtype=...): # -> None:
    ...
    def __getitem__(self, item): # -> _VT@OrderedDict | TableColumns | Row | Self@Table:
        ...
    ...
    def field(self, item): # -> _VT@OrderedDict | TableColumns:
    ...
    @property
    def ColumnClass(self): # -> Column | MaskedColumn:
        ...
    ...
    def values(self): # -> _odict_values[Unknown, Unknown]:
        ...
    ...
    def index_column(self, name): # -> int:
        """
    ...
    def add_column(self, col, index=..., name=..., rename_duplicate=..., copy=..., default_name=...): # -> None:
        """
    ...
    def add_columns(self, cols, indexes=..., names=..., copy=..., rename_duplicate=...): # -> None:
        """
    ...
    def replace_column(self, name, col, copy=...): # -> None:
        """
    ...
    def iterrows(self, *names): # -> zip[Unknown]:
        """
    ...
    def add_row(self, vals=..., mask=...): # -> None:
    ...
    def insert_row(self, index, vals=..., mask=...):
    ...
    def update(self, other, copy=...): # -> None:
        """
    ...
    def argsort(self, keys=..., kind=..., reverse=...): # -> ndarray[Any, dtype[Unknown]] | ndarray[Any, dtype[intp]]:
        """
    ...
    def sort(self, keys=..., *, kind=..., reverse=...): # -> None:
        '''
    ...
    def copy(self, copy_data=...): # -> Self@Table:
        '''
    ...
    def __deepcopy__(self, memo=...): # -> Self@Table:
        ...
    
    def __copy__(self): # -> Self@Table:
        ...
    ...
    def values_equal(self, other): # -> Table:
        """
    ...
    def to_pandas(self, index=..., use_nullable_int=...): # -> DataFrame:
        """
    ...
    @classmethod
    def from_pandas(cls, dataframe, index=..., units=...): # -> Self@Table:
        """
