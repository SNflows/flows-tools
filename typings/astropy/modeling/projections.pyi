...
"""
_PROJ_NAME_CODE = ...
_NOT_SUPPORTED_PROJ_CODES = ...
_PROJ_NAME_CODE_MAP = ...
projcodes = ...
__all__ = ['Projection', 'Pix2SkyProjection', 'Sky2PixProjection', 'Zenithal', 'Cylindrical', 'PseudoCylindrical', 'Conic', 'PseudoConic', 'QuadCube', 'HEALPix', 'AffineTransformation2D', 'projcodes'] + list(map('_'.join, product(['Pix2Sky', 'Sky2Pix'], chain(*_PROJ_NAME_CODE))))
...
class Pix2SkyProjection(Projection):
    ...
    def __new__(cls, *args, **kwargs): # -> Self@Pix2SkyProjection:
        ...
...
class Sky2PixProjection(Projection):
    ...
    _input_units_strict = ...
    _input_units_allow_dimensionless = ...
    def __new__(cls, *args, **kwargs): # -> Self@Sky2PixProjection:
        ...
...
class Pix2Sky_PlateCarree(Pix2SkyProjection, Cylindrical):
    ...
    """
    @staticmethod
    def evaluate(x, y): # -> tuple[NDArray[Unknown], NDArray[Unknown]]:
        ...
...
class Sky2Pix_PlateCarree(Sky2PixProjection, Cylindrical):
    ...
    """
    @staticmethod
    def evaluate(phi, theta): # -> tuple[NDArray[Unknown], NDArray[Unknown]]:
        ...
...
class AffineTransformation2D(Model):
    ...
    @property
    def inverse(self): # -> Self@AffineTransformation2D:
        """
    ...
    @classmethod
    def evaluate(cls, x, y, matrix, translation): # -> tuple[Any, Any]:
        """
    ...
    @property
    def input_units(self): # -> dict[Any, Any] | None:
        ...
