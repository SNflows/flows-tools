...
def read_ecsv(filename, index=..., *, move_to_meta=..., cosmology=..., **kwargs):
...
def write_ecsv(cosmology, file, *, overwrite=..., cls=..., cosmology_in_meta=..., **kwargs): # -> None:
...
def ecsv_identify(origin, filepath, fileobj, *args, **kwargs): # -> Literal[False]:
