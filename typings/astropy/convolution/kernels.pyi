...
__all__ = ['Gaussian1DKernel', 'Gaussian2DKernel', 'CustomKernel', 'Box1DKernel', 'Box2DKernel', 'Tophat2DKernel', 'Trapezoid1DKernel', 'RickerWavelet1DKernel', 'RickerWavelet2DKernel', 'AiryDisk2DKernel', 'Moffat2DKernel', 'Model1DKernel', 'Model2DKernel', 'TrapezoidDisk2DKernel', 'Ring2DKernel']
...
class Gaussian2DKernel(Kernel2D):
    ...
    _separable = ...
    _is_bool = ...
    def __init__(self, x_stddev, y_stddev=..., theta=..., **kwargs) -> None:
        ...
...
class Box1DKernel(Kernel1D):
    ...
    _separable = ...
    _is_bool = ...
    def __init__(self, width, **kwargs) -> None:
        ...
...
class Ring2DKernel(Kernel2D):
    ...
    Kernel response:
     ...
     .. plot::
        ...
        plt.show()
    """
    def __init__(self, radius_in, width, **kwargs) -> None:
        ...
...
class Trapezoid1DKernel(Kernel1D):
    ...
    """
    _is_bool = ...
    def __init__(self, width, slope=..., **kwargs) -> None:
        ...
...
class TrapezoidDisk2DKernel(Kernel2D):
    ...
    """
    _is_bool = ...
    def __init__(self, radius, slope=..., **kwargs) -> None:
        ...
...
class Moffat2DKernel(Kernel2D):
    ...
    """
    _is_bool = ...
    def __init__(self, gamma, alpha, **kwargs) -> None:
        ...
...
class CustomKernel(Kernel):
    ...
    @property
    def array(self): # -> NDArray[float64]:
        """
        Filter kernel array.
        """
        ...
