...
class FancyBboxPatch(Patch):
    stale: bool
    def __init__(self, xy, width, height, boxstyle: str = ..., bbox_transmuter: Incomplete | None = ..., mutation_scale: int = ..., mutation_aspect: int = ..., **kwargs) -> None: ...
...
class FancyArrowPatch(Patch):
    ...
    def get_mutation_aspect(self): ...
    def get_path(self): ...
    get_path_in_displaycoord: Incomplete
    def draw(self, renderer) -> None: ...
