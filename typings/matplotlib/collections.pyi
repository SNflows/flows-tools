...
class Collection(artist.Artist, cm.ScalarMappable):
    def __init__(self, edgecolors: Incomplete | None = ..., facecolors: Incomplete | None = ..., linewidths: Incomplete | None = ..., linestyles: str = ..., capstyle: Incomplete | None = ..., joinstyle: Incomplete | None = ..., antialiaseds: Incomplete | None = ..., offsets: Incomplete | None = ..., offset_transform: Incomplete | None = ..., norm: Incomplete | None = ..., cmap: Incomplete | None = ..., pickradius: float = ..., hatch: Incomplete | None = ..., urls: Incomplete | None = ..., *, zorder: int = ..., **kwargs) -> None: ...
    def get_paths(self): ...
...
class PathCollection(_CollectionWithSizes):
    stale: bool
    def __init__(self, paths, sizes: Incomplete | None = ..., **kwargs) -> None: ...
    def set_paths(self, paths) -> None: ...
    def get_paths(self): ...
    def legend_elements(self, prop: str = ..., num: str = ..., fmt: Incomplete | None = ..., func=..., **kwargs): ...

class PolyCollection(_CollectionWithSizes):
    stale: bool
    def __init__(self, verts, sizes: Incomplete | None = ..., closed: bool = ..., **kwargs) -> None: ...
    def set_verts(self, verts, closed: bool = ...) -> None: ...
    set_paths: Incomplete
...
class LineCollection(Collection):
    def __init__(self, segments, *, zorder: int = ..., **kwargs) -> None: ...
    stale: bool
    def set_segments(self, segments) -> None: ...
    set_verts: Incomplete
    set_paths: Incomplete
    def get_segments(self): ...
    def set_color(self, c) -> None: ...
    set_colors: Incomplete
    def get_color(self): ...
    get_colors: Incomplete

class EventCollection(LineCollection):
    def __init__(self, positions, orientation: str = ..., lineoffset: int = ..., linelength: int = ..., linewidth: Incomplete | None = ..., color: Incomplete | None = ..., linestyle: str = ..., antialiased: Incomplete | None = ..., **kwargs) -> None: ...
    def get_positions(self): ...
    def set_positions(self, positions) -> None: ...
    def add_positions(self, position) -> None: ...
    extend_positions: Incomplete
    append_positions: Incomplete
...
class PatchCollection(Collection):
    def __init__(self, patches, match_original: bool = ..., **kwargs) -> None: ...
