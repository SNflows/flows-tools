...
class XMLWriter:
    ...
    def end(self, tag: Incomplete | None = ..., indent: bool = ...) -> None: ...
    def close(self, id) -> None: ...
    def element(self, tag, text: Incomplete | None = ..., attrib=..., **extra) -> None: ...
    def flush(self) -> None: ...

def generate_transform(transform_list: Incomplete | None = ...): ...
def generate_css(attrib: Incomplete | None = ...): ...
...
class RendererSVG(RendererBase):
    ...
    basename: Incomplete
    def __init__(self, width, height, svgwriter, basename: Incomplete | None = ..., image_dpi: int = ..., *, metadata: Incomplete | None = ...) -> None: ...
...
class FigureCanvasSVG(FigureCanvasBase):
    ...
    fixed_dpi: int
    def print_svg(self, filename, *args, bbox_inches_restore: Incomplete | None = ..., metadata: Incomplete | None = ...) -> None: ...
