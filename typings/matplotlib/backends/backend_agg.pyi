...
class RendererAgg(RendererBase):
    ...
    def restore_region(self, region, bbox: Incomplete | None = ..., xy: Incomplete | None = ...) -> None: ...
    def start_filter(self) -> None: ...
    def stop_filter(self, post_processing) -> None: ...

class FigureCanvasAgg(FigureCanvasBase):
    def copy_from_bbox(self, bbox): ...
    def restore_region(self, region, bbox: Incomplete | None = ..., xy: Incomplete | None = ...): ...
    renderer: Incomplete
    def draw(self) -> None: ...
    ...
    print_rgba: Incomplete
    def print_png(self, filename_or_obj, *args, metadata: Incomplete | None = ..., pil_kwargs: Incomplete | None = ...) -> None: ...
    def print_to_buffer(self): ...
    def print_jpg(self, filename_or_obj, *args, pil_kwargs: Incomplete | None = ...) -> None: ...
    print_jpeg: Incomplete
    def print_tif(self, filename_or_obj, *, pil_kwargs: Incomplete | None = ...) -> None: ...
    print_tiff: Incomplete
    def print_webp(self, filename_or_obj, *, pil_kwargs: Incomplete | None = ...) -> None: ...
